		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title">기업회원 상세</h3>
				</div>
				<!-- /.box-header -->

				<form role="form" action="cmodifyPage" method="post">
					<input type='hidden' name='com_id' value="${companyVO.com_id}">
	...
	<script>
		$(document).ready(function() {
			...
			$(".btn-warning").on("click", function() {
				formObj.attr("action", "cmodifyPage");
				formObj.attr("method", "get");
				formObj.submit();
			});

			$(".btn-danger").on("click", function() {
				formObj.attr("action", "cremove");
				formObj.submit();
			});

			$(".btn-primary").on("click", function() {
				formObj.attr("method", "get");
				formObj.attr("action", "companyList");
				formObj.submit();
			});
		});
	</script>
