	...
	<div class="container">
		<div class='box'>
			<div class="box-header with-border">
				<h1 style="font-size: 30px" class="box-title"><strong>기타</strong></h1>
			</div>
			<div class='box-body'>
				<table class="table table-striped">
					...
					<tr onclick="location.href='/cboard/etc/etcdetail?ttr_no=${boardVO.ttr_no}'">
				...
				<a href="/cboard/write/etc"><button class="btn btn-primary" >글 작성</button></a>
			</div>
		</div>
