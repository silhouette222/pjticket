...
<div class="container">
	...
	<div class='box'>
		...
		<div class="box-body text-right">
			<a href="/cboard/mc"><button class="btn btn-primary">목록</button></a>
			<c:if test="${boardVO.com_id eq loginUser.com_id }">
				<a href="/cboard/mc/mcupdate?ttr_no=${boardVO.ttr_no }"><button class="btn btn-primary">수정</button></a>
				<a href="/cboard/mc/delete?ttr_no=${boardVO.ttr_no }"><button class="btn btn-primary">삭제</button></a>						
			</c:if>
		</div>
	</div>
