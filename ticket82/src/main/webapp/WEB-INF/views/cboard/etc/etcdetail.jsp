...
<a href="/cboard/etc"><button>목록</button></a>
<c:if test="${boardVO.com_id eq loginUser.com_id }">
	<a href="/cboard/etc/etcupdate?ttr_no=${boardVO.ttr_no }"><button>수정</button></a>
	<a href="/cboard/etc/delete?ttr_no=${boardVO.ttr_no }"><button>삭제</button></a>						
</c:if>
