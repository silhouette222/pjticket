	...
	<div class="container">
		...
		<div class='box'>
			<div class="box-header with-border">
				<h1 style="font-size: 30px" class="box-title"><strong>연극</strong></h1>
			</div>
			<div class='box-body'>
				<table class="table table-striped">
					...
					<tr onclick="location.href='/cboard/play/playdetail?ttr_no=${boardVO.ttr_no}'">						<td><img src="/displayFile?fileName=${boardVO.thumb_name}"></td>
						<td>
				...
				<a href="/cboard/write/play"><button class="btn btn-primary" >글 작성</button></a>
			</div>
		</div>
	</div>
