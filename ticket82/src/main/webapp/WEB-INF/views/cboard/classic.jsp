		...
		<div class='box'>
			...
			<div class='box-body'>
				<table class="table table-striped">
					...
					<tr onclick="location.href='/cboard/classic/classicdetail?ttr_no=${boardVO.ttr_no}'">						<td><img src="/displayFile?fileName=${boardVO.thumb_name}"></td>
						<td>
				...
				<a href="/cboard/write/classic"><button class="btn btn-primary" >글 작성</button></a>
			</div>
		</div>
	</div>
