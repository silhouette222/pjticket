			...
			<c:if test="${mainVO.main_id eq 'musical1' }">
   			<div class="ticketFamousCube">
   				<div class="item">
					...
					<a href="/mboard/mc/mcdetail?ttr_no=${mainVO.ttr_no}">
			...
			<c:if test="${mainVO.main_id eq 'concert1' }">
   			<div class="ticketFamousCube">
   				<div class="item">
					...
					<a href="/mboard/cc/ccdetail?ttr_no=${mainVO.ttr_no}">
						<img src="/displayFile?fileName=${mainVO.main_path}">
					</a>
   				</div>
   			</div>
			...
			<c:if test="${mainVO.main_id eq 'play1' }">
   			<div class="ticketFamousCube">
   				<div class="item">
					...
					<a href="/mboard/play/playdetail?ttr_no=${mainVO.ttr_no}">
						<img src="/displayFile?fileName=${mainVO.main_path}">
					</a>
   				</div>
   			</div>
			...
			<c:if test="${mainVO.main_id eq 'classic1' }">
   			<div class="ticketFamousCube">
   				<div class="item">
					...
					<a href="/mboard/classic/classicdetail?ttr_no=${mainVO.ttr_no}">
						<img src="/displayFile?fileName=${mainVO.main_path}">
					</a>
   				</div>
   			</div>
